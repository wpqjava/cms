...
<body>
	<div id="content_add">
		...
		<table cellspacing="0" cellPadding="0" id="addTable">
			<thead><tr><td colspan="2">组信息</td></tr></thead>
				<tr>
					<td class="leftTd">组名称:</td>
					<td class="rightTd"><span>${group.name }</span></td>
				</tr>
				<tr>
					<td class="leftTd">组描述:</td>
					<td class="rightTd"><textarea cols="60" rows="5" readonly="readonly">${group.descri }</textarea></td>
				</tr>
				<tr>
					<td class="leftTd">组成员:</td>
					<td class="rightTd">
