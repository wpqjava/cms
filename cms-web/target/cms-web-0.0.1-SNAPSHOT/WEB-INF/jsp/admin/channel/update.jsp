...
<body>
	<div id="content_add">
		<sf:form method="post" modelAttribute="channel" id="updateForm">
		<table class="cc-addTable" cellspacing="0" cellPadding="0">
			<thead><tr><td colspan="2">更新[${channel.name}]栏目功能</td></tr></thead>
			<tr>
			...
			<tr>
				...
				<td>
				<sf:radiobutton path="isTopIntro" value="0"/>是
				<sf:radiobutton path="isTopIntro" value="1"/>否
				</td>
			</tr>
			<tr>
